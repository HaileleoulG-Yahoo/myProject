      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="main_nav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"> ADDITIONAL SERVICES </a>
              <ul id="additional-services-dropdown" class="dropdown-menu fade-up">
                <li><a class="dropdown-item" href="https://ushouse.sharepoint.com/sites/HumanResources/CAOHRHUB/SitePages/AdditionalServices.aspx#"> <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Additional Services &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> </a></li>
              </ul>
            </li>
...
// 
  ...
  <ul class="list-unstyled components" style="padding:0px; margin:0px;">
    ...
    <li id="AdditionalServices_link"> 
        <a id="AdditionalServices" href="https://ushouse.sharepoint.com/sites/HumanResources/CAOHRHUB/SitePages/AdditionalServices.aspx#">Additional Services</a>
    </li>
