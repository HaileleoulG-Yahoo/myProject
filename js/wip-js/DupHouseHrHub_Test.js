...
$(document).ready(function () {
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <ul id="additional-services-dropdown" class="dropdown-menu fade-up">
                  <li><a class="dropdown-item" href="https://ushouse.sharepoint.com/sites/HumanResources/CAOHRHUB/SitePages/AdditionalServices.aspx#"> Additional Services </a></li>
                </ul>
              </li>
  ...
  // 
    if(currentUrl.includes('Hiring') || currentUrl.includes('Recruiting') ||currentUrl.includes('Salary&Benefits') || currentUrl.includes('Onboarding') ){
