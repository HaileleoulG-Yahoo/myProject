...
function position_modal(position) {
   ...
   oDataVisitedPage = siteurl + "/_api/web/lists/getbytitle('Career-Path-Position')/items?$select=Job_Title,Similar_Job_Titles,Job_Summary,Top_Skill_1,Top_Skill_1_Rating,Top_Skill_2,Top_Skill_2_Rating,Top_Skill_3,Top_Skill_3_Rating,Top_Skill_4,Top_Skill_4_Rating,Top_Skill_5,Top_Skill_5_Rating&$filter=Job_Title eq '" + position + "'&$top=1";

   //console.log("oDataVisitedPage : ",oDataVisitedPage);
       ...
       success: function (data) {
           ...
           <div class="modal fade" id="staticBackdrop${_Position}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                 ...
                 <div class="modal-dialog">
                     <div class="modal-content">
                         ...
                         <div class="modal-body">
                             ...
                             <p style="text-align:left;"><b>Job Summary</b>: ${_Job_Summary} </p>
                             ...
                             <div class="container position-container">
                                 <div class="row" style="margin:1rem; margin-left:0px;">
                                     <div class="col"
                                         style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; text-align:left;">
         
         
                                         <body>
                                             <span class="hovertextAdaptability" data-hover="Definition for Adaptability">
                                             ${_Top_Skill_1} :
                                             </span>
                                         </body>
               ...
               htmlPositionmodal = htmlPositionmodal + `      
                                 ...
                                 <div class="row" style="margin:.75rem; margin-left:0px;">
                                     <div class="col"
                                         style="font-family:Arial, Helvetica, sans-serif; font-weight:bold; text-align:left;">
         
                                         <body>
                                             <span class="hovertextAttentionToDetail"
                                                 data-hover="Definition for Constituent Service Driven">
                                                 ${_Top_Skill_2} :
                                             </span>
                                         </body>
               ...
               htmlPositionmodal = htmlPositionmodal + `            
                                 ...
                                 <div class="row" style="margin:.75rem; margin-left:0px;">
                                     <div class="col"
                                         ...
                                         <body>
                                             <span class="hovertextResearchAndAnalysis" data-hover="Definition for Initiative">
                                             ${_Top_Skill_3} :
                                             </span>
                                         </body>
               ...
               htmlPositionmodal = htmlPositionmodal + `
                                 ...
                                 <div class="row" style="margin:.75rem; margin-left:0px;">
                                     <div class="col"
                                         ...
                                         <body>
                                             <span class="hovertextInterpersonalSkills"
                                                 data-hover="Definition for Interpersonal Skills">
                                                 ${_Top_Skill_4} :
                                             </span>
                                         </body>
               ...
               htmlPositionmodal = htmlPositionmodal + `          
                                 ...
                                 <div class="row" style="margin:.75rem; margin-left:0px;">
                                     <div class="col"
                                         ...
                                         <body>
                                             <span class="hovertextTeamwork" data-hover="Definition for Written Communication">
                                             ${_Top_Skill_5} :
                                             </span>
                                         </body>
...
function showDefination(Skill){
  ...
  if (Skill === "Adaptability"){
   ...
   if(document.getElementById("Defination_Adaptability").style.display === "none"){
       document.getElementById("Defination_Adaptability").style.display = "block";
   } else{
       document.getElementById("Defination_Adaptability").style.display = "none";
   }

  }if (Skill === "Initiative"){

   if(document.getElementById("Defination_Initiative").style.display === "none"){
       document.getElementById("Defination_Initiative").style.display = "block";
   } else{
       document.getElementById("Defination_Initiative").style.display = "none";
   }

  }if (Skill === "Constituent Service Driven"){

   if(document.getElementById("Defination_Initiative_Constituent_Service_Driven").style.display === "none"){
       document.getElementById("Defination_Initiative_Constituent_Service_Driven").style.display = "block";
   } else{
       document.getElementById("Defination_Initiative_Constituent_Service_Driven").style.display = "none";
   }

  }if (Skill === "Interpersonal Skills"){

   if(document.getElementById("Defination_Interpersonal_Skills").style.display === "none"){
       document.getElementById("Defination_Interpersonal_Skills").style.display = "block";
   } else{
       document.getElementById("Defination_Interpersonal_Skills").style.display = "none";
   }

  }if (Skill === "Written Communication"){

   if(document.getElementById("Defination_Written_Communication").style.display === "none"){
       document.getElementById("Defination_Written_Communication").style.display = "block";
   } else{
       document.getElementById("Defination_Written_Communication").style.display = "none";
   }
